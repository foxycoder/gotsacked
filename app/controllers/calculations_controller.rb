...
class CalculationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @calculation.save
        format.html { redirect_to action:"edit", id:@calculation.id}
  ...
  def update
    respond_to do |format|
      if @calculation.update(calculation_params)
        format.html { redirect_to action: 'edit', id: @calculation.id, notice: 'Calculation was successfully updated.' }
  ...
  private
    ...
    def calculation_params
      params.require(:calculation).permit(:age, :working_years, :working_years_total, :profession, :gross_salary, :education_level, :email_address)
    end
end
